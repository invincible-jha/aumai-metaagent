# Contributing to AumAI Metaagent
...
### Setup
```bash
git clone https://github.com/aumai/aumai-metaagent.git
cd aumai-metaagent
python -m venv .venv
...
### Good First Issues
New to the project? Start with issues labeled [`good first issue`](https://github.com/aumai/aumai-metaagent/labels/good%20first%20issue).
...
- [GitHub Discussions](https://github.com/aumai/aumai-metaagent/discussions)
